...
export default function ForgotPass() {
  ...
  return (
    <div className="forgot-pass-container" style={{ backgroundColor: "#7cb580", border: "3px solid #7d9c7b", borderRadius: "10px", minHeight: "100vh", display: "flex", flexDirection: "column", justifyContent: "center" }}>
